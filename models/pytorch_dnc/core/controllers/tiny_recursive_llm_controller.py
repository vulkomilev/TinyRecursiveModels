...
class TinyRecursiveLLMController(Controller):
    def __init__(self, args):
        super(TinyRecursiveLLMController, self).__init__(args)

        # build model
        self.in_2_hid = TinyRecursiveReasoningModel_ACTV1(self.input_dim + self.read_vec_dim, self.hidden_dim, 1)
