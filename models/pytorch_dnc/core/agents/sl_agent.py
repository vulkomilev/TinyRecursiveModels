...
class SLAgent(Agent):   # for supervised learning tasks
    ...
    def _backward(self):
        ...
        #if self.training:
        #    loss_vb.backward()#(retain_graph=True)
        #    self.optimizer.step()
    ...
    def fit_model(self):    # the most basic control loop, to ease integration of new envs
        ...
        while self.step < self.steps:
            ...
            if self.step % self.prog_freq == 0:
                ...
                #for i,element in enumerate(self.training_loss_avg_log):
                    #print('element',element)
                #    self.training_loss_avg_log[i] = element[0].cpu()
    ...
    def _eval_model(self):
        ...
        for i, element in enumerate(eval_loss_avg_log):
            # print('element',element)
            eval_loss_avg_log[i] = element[0].cpu()
