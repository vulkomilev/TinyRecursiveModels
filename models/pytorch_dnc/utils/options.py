...
class Params(object):   # NOTE: shared across all modules
    def __init__(self):
        ...
        #torch.bfloat16
        self.dtype       = torch.bfloat16 #torch.cuda.FloatTensor # if torch.cuda.is_available() else torch.FloatTensor
        ...
        # logging configs
        self.log_name    = self.root_dir + "/models/pytorch_dnc/logs/" + self.refs + ".log"
